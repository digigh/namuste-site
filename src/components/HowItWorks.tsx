...
const steps = [
  {num:"01",title:"Customer Visits the Counter",desc:"A rural customer walks into a local retail shop to buy products — seeds, FMCG goods, hardware, medicines or any product category.",c:"#8b5cf6",gc:"rgba(139,92,246,.15)",bc:"rgba(139,92,246,.3)",icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg>},
  {num:"02",title:"Product QR Scanned",desc:"The retailer scans the product's QR code on the Namusté device. Customer details and campaign eligibility are verified instantly in real time.",c:"#10b981",gc:"rgba(16,185,129,.12)",bc:"rgba(16,185,129,.25)",icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3h-3zm3 3h4v4h-4z"/></svg>},
  {num:"03",title:"Retailer Reviews & Approves",desc:"The retailer sees the campaign offer on the device screen and approves the transaction — completing the digital record in seconds.",c:"#a78bfa",gc:"rgba(167,139,250,.15)",bc:"rgba(167,139,250,.3)",icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>},
  {num:"04",title:"Customer Gets Rewarded",desc:"Upon approval, the customer receives their brand offer — a discount, cashback, loyalty point or reward — instantly and digitally.",c:"#6ee7b7",gc:"rgba(110,231,183,.12)",bc:"rgba(110,231,183,.25)",icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77Z"/><path d="m9 12 2 2 4-4"/></svg>},
];
      ...
      <div style={{maxWidth:1280,margin:"0 auto",padding:"0 44px",position:"relative",zIndex:2}}>
        <div className="reveal" style={{textAlign:"center",maxWidth:600,margin:"0 auto 72px"}}>
          ...
          <p style={{color:"rgba(255,255,255,.38)",fontSize:16,lineHeight:1.75}}>
            From customer arrival to reward delivery — the entire rural retail journey runs through Namusté.
          </p>
        </div>
