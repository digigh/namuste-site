...
const problems = [
  {num:"01",title:"The rural counter has no digital record",desc:"Hundreds of crores flow through rural retail counters every day — and virtually none of it is digitally tracked. Brands operate on distributor estimates, not real data.",color:"#a78bfa",bg:"rgba(139,92,246,.08)",border:"rgba(139,92,246,.18)"},
  {num:"02",title:"Brand schemes travel by WhatsApp",desc:"Trade promotions, loyalty schemes and seasonal campaigns are communicated by printout and WhatsApp group — untracked, unverified and invisible to the brand.",color:"#6ee7b7",bg:"rgba(16,185,129,.06)",border:"rgba(16,185,129,.15)"},
  {num:"03",title:"Rural retail is completely offline",desc:"The rural counter — where billions of transactions happen — has zero digital infrastructure. No inventory system, no payment data, no campaign tracking, no connection to the formal economy.",color:"#f87171",bg:"rgba(248,113,113,.06)",border:"rgba(248,113,113,.15)"},
];
        ...
        <div style={{maxWidth:1280,margin:"0 auto",padding:"0 44px",position:"relative",zIndex:2}}>
          <div className="reveal" style={{textAlign:"center",maxWidth:620,margin:"0 auto 64px"}}>
            ...
            <p style={{color:"rgba(255,255,255,.38)",fontSize:16,lineHeight:1.8}}>
              Namusté is the digital infrastructure layer connecting brands, distributors, retailers and customers — at the rural counter, for the first time.
            </p>
          </div>
