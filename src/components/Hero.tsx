...
const nodes = [
  { label:"Brand",      col:"#a78bfa", bg:"rgba(139,92,246,.12)", border:"rgba(139,92,246,.3)", icon:<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77Z"/><path d="m9 12 2 2 4-4"/></svg> },
  { label:"Retailer",   col:"#6ee7b7", bg:"rgba(16,185,129,.1)", border:"rgba(16,185,129,.25)", icon:<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect width="14" height="20" x="5" y="2" rx="2"/><path d="M12 18h.01"/></svg> },
  { label:"Farmer",     col:"#c4b5fd", bg:"rgba(139,92,246,.14)", border:"rgba(139,92,246,.32)", icon:<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg> },
  { label:"Distributor",col:"#6ee7b7", bg:"rgba(16,185,129,.1)", border:"rgba(16,185,129,.25)", icon:<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/></svg> },
    ...
    <section id="product" style={{
      ...
      <div style={{textAlign:"center",padding:"52px 24px 0",position:"relative",zIndex:10,width:"100%",maxWidth:900,margin:"0 auto"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:12,marginBottom:20}}>
          ...
          <span style={{color:"rgba(196,181,253,.42)",fontSize:11,fontWeight:500,letterSpacing:".08em"}}>India&apos;s First Agri Retail Operating System</span>
          <div style={{height:1,width:44,background:"linear-gradient(90deg,rgba(139,92,246,.5),transparent)"}}/>
        </div>
        {/* Single combined headline — no line break issues */}
        ...
        <p style={{color:"rgba(255,255,255,.36)",fontSize:16,lineHeight:1.85,maxWidth:500,margin:"0 auto 30px"}}>
          One device. Every transaction tracked. Every campaign connected. Every farmer rewarded. The counter is no longer dark.
        </p>
      ...
      {/* ── NETWORK ILLUSTRATION ── full-width 3-column layout ── */}
      <div style={{width:"100%",maxWidth:1100,padding:"0 32px",position:"relative",zIndex:5,display:"grid",gridTemplateColumns:"180px 1fr 180px",gap:0,alignItems:"center"}}>
        ...
        <div className="af2" style={{alignSelf:"center",justifySelf:"start"}}>
          <div style={{background:"rgba(8,2,22,.9)",border:"1px solid rgba(139,92,246,.22)",borderRadius:16,padding:"16px 18px",backdropFilter:"blur(16px)",boxShadow:"0 12px 40px rgba(139,92,246,.12)",minWidth:160}}>
            ...
            <div className="hf" style={{color:"#fff",fontSize:26,fontWeight:900,letterSpacing:"-.5px",lineHeight:1,marginBottom:6}}>₹3L Cr+</div>
        ...
        {/* CENTER: SVG paths + nodes + orb */}
        <div style={{position:"relative"}}>
          {/* SVG: lines + traveling dots */}
          <svg width="100%" viewBox="0 0 580 300" style={{position:"absolute",top:0,left:0,overflow:"visible"}}>
            <path d="M58,42  C160,120 240,180 290,230" stroke="rgba(139,92,246,.22)" strokeWidth="1.5" fill="none" strokeDasharray="6 4">
              <animate attributeName="stroke-dashoffset" from="24" to="0" dur=".8s" repeatCount="indefinite"/>
            </path>
            <path d="M174,24 C220,100 258,160 290,230" stroke="rgba(167,139,250,.18)" strokeWidth="1.5" fill="none" strokeDasharray="6 4">
              <animate attributeName="stroke-dashoffset" from="24" to="0" dur=".8s" begin=".3s" repeatCount="indefinite"/>
            </path>
            <path d="M290,12 L290,230" stroke="rgba(139,92,246,.26)" strokeWidth="1.5" fill="none" strokeDasharray="6 4">
              <animate attributeName="stroke-dashoffset" from="24" to="0" dur=".8s" begin=".6s" repeatCount="indefinite"/>
            </path>
            <path d="M406,24 C360,100 322,160 290,230" stroke="rgba(110,231,183,.18)" strokeWidth="1.5" fill="none" strokeDasharray="6 4">
              <animate attributeName="stroke-dashoffset" from="24" to="0" dur=".8s" begin=".9s" repeatCount="indefinite"/>
            </path>
            <path d="M522,42 C420,120 340,180 290,230" stroke="rgba(139,92,246,.22)" strokeWidth="1.5" fill="none" strokeDasharray="6 4">
              <animate attributeName="stroke-dashoffset" from="24" to="0" dur=".8s" begin="1.2s" repeatCount="indefinite"/>
            </path>
            ...
            {/* Traveling dots */}
            <circle r="3.5" fill="#8b5cf6" opacity=".9">
              <animateMotion dur="2.5s" repeatCount="indefinite"><mpath href="#l1"/></animateMotion>
            </circle>
            <circle r="3" fill="#6ee7b7" opacity=".85">
              <animateMotion dur="3s" repeatCount="indefinite" begin=".7s"><mpath href="#l3"/></animateMotion>
            </circle>
            <circle r="3" fill="#a78bfa" opacity=".85">
              <animateMotion dur="2.8s" repeatCount="indefinite" begin="1.4s"><mpath href="#l5"/></animateMotion>
            </circle>
            <circle r="2.5" fill="#6ee7b7" opacity=".75">
              <animateMotion dur="3.2s" repeatCount="indefinite" begin=".4s"><mpath href="#l4"/></animateMotion>
            </circle>
          ...
          {/* Node icons row — evenly spaced, clear of stat cards */}
          <div style={{display:"flex",justifyContent:"space-between",paddingTop:0,height:88,alignItems:"flex-start",position:"relative",zIndex:10}}>
            {nodes.map((n, i) => (
              <div key={n.label} className="af1" style={{textAlign:"center",animationDelay:`${i*.3}s`,width:70,flexShrink:0}}>
                <div style={{width:46,height:46,borderRadius:13,background:n.bg,border:`1px solid ${n.border}`,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 7px",backdropFilter:"blur(8px)",color:n.col,boxShadow:`0 4px 20px ${n.bg}`}}>
                  {n.icon}
                </div>
                <div style={{color:"rgba(255,255,255,.4)",fontSize:9,fontWeight:500,letterSpacing:".02em"}}>{n.label}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{display:"flex",justifyContent:"center",gap:14,position:"relative",zIndex:20,paddingTop:4}}>
            <div className="af1" style={{background:"rgba(8,2,22,.9)",border:"1px solid rgba(139,92,246,.2)",borderRadius:12,padding:"9px 14px",backdropFilter:"blur(14px)",display:"flex",alignItems:"center",gap:9}}>
              ...
              <div>
                <div style={{color:"rgba(167,139,250,.5)",fontSize:8,fontWeight:600,letterSpacing:".07em"}}>CAMPAIGNS</div>
                <div className="hf" style={{color:"#fff",fontSize:12,fontWeight:700}}>3 Brands Active</div>
              </div>
            </div>
            <div className="af2" style={{background:"rgba(8,2,22,.9)",border:"1px solid rgba(16,185,129,.2)",borderRadius:12,padding:"9px 14px",backdropFilter:"blur(14px)",display:"flex",alignItems:"center",gap:9}}>
              ...
              <div>
                ...
                <div className="hf" style={{color:"#fff",fontSize:12,fontWeight:700}}>₹240 · Verified ✓</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="af3" style={{alignSelf:"center",justifySelf:"end"}}>
          <div style={{background:"rgba(8,2,22,.9)",border:"1px solid rgba(16,185,129,.2)",borderRadius:16,padding:"16px 18px",backdropFilter:"blur(16px)",boxShadow:"0 12px 40px rgba(16,185,129,.1)",minWidth:160}}>
            <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:8}}>
              ...
              <span style={{color:"rgba(110,231,183,.55)",fontSize:9,fontWeight:600,letterSpacing:".07em"}}>OPPORTUNITY</span>
            </div>
            ...
            <div style={{display:"flex",alignItems:"center",gap:5}}>
              ...
              <span style={{color:"#6ee7b7",fontSize:10,fontWeight:600}}>Farmers in India</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <style>{`
        ...
        @media(max-width:900px){
          .hero-net{grid-template-columns:1fr!important}
